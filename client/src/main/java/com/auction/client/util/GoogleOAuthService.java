            ...
            server.createContext("/callback", exchange -> {
                ...
                if (code != null) {
                    responseHtml = "<!DOCTYPE html>"
                            ...
                            + "    <p>Xác thực tài khoản Google hoàn tất.<br>Vui lòng quay lại ứng dụng <strong>BidPop</strong>.</p>"
                            + "    <div class='countdown-container'>"
                            + "      Cửa sổ sẽ tự đóng sau <strong id='countdown'>5</strong> giây."
                            + "      <div class='progress-bar-container'>"
                            + "        <div id='progress' class='progress-bar'></div>"
                            + "      </div>"
                            + "    </div>"
                            + "    <div class='close-hint'>Nếu trang không tự đóng, bạn có thể đóng thủ công.</div>"
                            + "  </div>"
                            + "  <script>"
                    ...
                    responseHtml = "<!DOCTYPE html>"
                            ...
                            + "    <p>Đã xảy ra lỗi trong quá trình xác thực với Google.<br>Chi tiết: <strong>" + errorText + "</strong></p>"
                            + "    <div class='close-hint'>Bạn có thể đóng trang này và thực hiện lại thao tác.</div>"
                            + "  </div>"
                            + "</body>"
                            + "</html>";
                    exchange.getResponseHeaders().set("Content-Type", "text/html; charset=UTF-8");
