...
public class Config {
    static final String DEFAULT_API_URL = "https://server-bai-tap-lon.shin25112007.workers.dev";
    static final String DEFAULT_SOCKET_HOST = "server-bai-tap-lon.shin25112007.workers.dev";
    static final int DEFAULT_SOCKET_PORT = 443;
    ...
    static Integer readPositiveIntConfig(
            String systemPropertyName,
            String envName,
            int defaultValue
    ) {
        String rawValue = readTextConfig(
                systemPropertyName,
                envName,
