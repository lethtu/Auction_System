...
public class AuctionPageController {
    ...
    public void handleAutoBidConfig(ActionEvent event) {
        ...
        minBtn.setOnMouseEntered(ev -> minBtn.setStyle("-fx-background-color: -app-surface-2; -fx-font-weight: bold; -fx-text-fill: -fx-accent; -fx-cursor: hand; -fx-font-size: 16px; -fx-background-radius: 8;"));
        ...
        maxBtn.setOnMouseEntered(ev -> maxBtn.setStyle("-fx-background-color: -app-surface-2; -fx-font-weight: bold; -fx-text-fill: -fx-accent; -fx-cursor: hand; -fx-font-size: 16px; -fx-background-radius: 8;"));
    ...
    private void updateResponsiveFonts(double windowWidth) {
        ...
        setNodeStyle(currentPriceLabel,
                "-fx-font-family: 'DM Sans'; -fx-font-size: " + (int) priceFont + "px; -fx-font-weight: 900; -fx-text-fill: -fx-accent;"
        );
        ...
        setNodeStyle(startPriceLabel,
                "-fx-font-family: 'DM Sans'; -fx-font-size: " + (int) startPriceFont + "px; -fx-font-weight: 900; -fx-text-fill: -fx-accent;"
        );
        ...
        setNodeStyle(productNameLabel,
                "-fx-font-family: 'DM Sans'; -fx-font-size: " + (int) productNameFont + "px; -fx-font-weight: 900; -fx-text-fill: -fx-accent;"
        );
